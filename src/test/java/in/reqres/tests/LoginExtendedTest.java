...
import in.reqres.models.lombok.MissingPasswordLoginLombokModel;
...
public class LoginExtendedTest extends TestBase {
    ...
    void missingPasswordTest() {
        ...
        MissingPasswordLoginLombokModel response = step("Make login request",() ->
                given(loginRequestSpec)
                        .body(authData)
                        .when()
                        .post("/login")
                        ...
                        .extract().as(MissingPasswordLoginLombokModel.class));
